 ...
 * SOFTWARE.
 */
package space.meowcats.subayai.nodes.interop;
...
public abstract class NodeObjectDescriptor implements TruffleObject {
    ...
    static final class ReadDescriptor extends NodeObjectDescriptor {
        ...
        private static final TruffleObject KEYS_READ = new NodeObjectDescriptorKeys(SubayaiStrings.constant(StandardTags.ReadVariableTag.NAME));
    ...
    static final class WriteDescriptor extends NodeObjectDescriptor {
        ...
        private static final TruffleObject KEYS_WRITE = new NodeObjectDescriptorKeys(SubayaiStrings.constant(StandardTags.WriteVariableTag.NAME));
