...
public abstract class SubayaiBuiltinAstNode extends SubayaiExpressionNode {

    final int argumentCount;
    @Child private SubayaiBuiltinNode builtin;

    SubayaiBuiltinAstNode(int argumentCount, SubayaiBuiltinNode builtinNode) {
