...
/**
 * The root of all Subayai execution trees. It is a Truffle requirement that the tree root extends the
 * class {@link RootNode}. This class is used for both builtin and user-defined functions. For
 * builtin functions, the {@link #bodyNode} is a subclass of {@link SubayaiBuiltinNode}. For user-defined
 * functions, the {@link #bodyNode} is a {@link SubayaiFunctionBodyNode}.
 */
@NodeInfo(language = "Subayai", description = "The root of all Subayai execution trees")
public abstract class SubayaiRootNode extends RootNode {

    protected transient boolean isCloningAllowed;

    public SubayaiRootNode(SubayaiLanguage language, FrameDescriptor frameDescriptor) {
    ...
    public abstract SubayaiExpressionNode getBodyNode();
