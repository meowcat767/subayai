...
public final class SubayaiIfNode extends SubayaiStatementNode {

    /**
     * The condition of the {@code if}. This in a {@link SubayaiExpressionNode} because we require a
    ...
    /** Statement (or {@link SubayaiBlockNode block}) executed when the condition is true. */
    @Child private SubayaiStatementNode thenPartNode;

    /** Statement (or {@link SubayaiBlockNode block}) executed when the condition is false. */
    @Child private SubayaiStatementNode elsePartNode;
    ...
    public SubayaiIfNode(SubayaiExpressionNode conditionNode, SubayaiStatementNode thenPartNode, SubayaiStatementNode elsePartNode) {
    ...
    public void executeVoid(VirtualFrame frame) {
        ...
        if (condition.profile(evaluateCondition(frame))) {
            ...
            /* Execute the else-branch (which is optional according to the Subayai syntax). */
