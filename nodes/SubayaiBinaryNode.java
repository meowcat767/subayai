 ...
 * "right"). For concrete subclasses of this class, the Truffle DSubayai creates two child fields, and
 * the necessary constructors and logic to set them.
 */
@NodeChild("leftNode")
@NodeChild("rightNode")
public abstract class SubayaiBinaryNode extends SubayaiExpressionNode {
}
