 ...
 */
@NodeInfo(shortName = "||")
public final class SubayaiLogicalOrNode extends SubayaiShortCircuitNode {

    public SubayaiLogicalOrNode(SubayaiExpressionNode left, SubayaiExpressionNode right) {
        super(left, right);
    }
