 ...
 */
@NodeInfo(shortName = "&&")
public final class SubayaiLogicalAndNode extends SubayaiShortCircuitNode {

    public SubayaiLogicalAndNode(SubayaiExpressionNode left, SubayaiExpressionNode right) {
        super(left, right);
    }
