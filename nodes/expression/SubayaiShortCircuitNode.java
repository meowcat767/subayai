...
/**
 * Logical operations in Subayai use short circuit evaluation: if the evaluation of the left operand
 * already decides the result of the operation, the right operand must not be executed. This is
 * expressed in using this base class for {@link SubayaiLogicalAndNode} and {@link SubayaiLogicalOrNode}.
 */
public abstract class SubayaiShortCircuitNode extends SubayaiExpressionNode {

    @Child private SubayaiExpressionNode left;
    @Child private SubayaiExpressionNode right;
    ...
    public SubayaiShortCircuitNode(SubayaiExpressionNode left, SubayaiExpressionNode right) {
        this.left = left;
        this.right = right;
    }
    ...
    public final boolean executeBoolean(VirtualFrame frame) {
        ...
        try {
            ...
            throw SubayaiException.typeError(this, "toBoolean", e.getResult());
        }
        boolean rightValue;
        try {
