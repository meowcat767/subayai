...
import space.meowcats.subayai.nodes.util.SubayaiToMemberNode;
...
public abstract class SubayaiWritePropertyNode extends SubayaiExpressionNode {
    ...
    public static Object writeArray(Object receiver, Object index, Object value,
        ...
        try {
            ...
            // read was not successful. In Subayai we only have basic support for errors.
            throw SubayaiException.undefinedProperty(node, index);
        }
        return value;
    }

    @Specialization(limit = "LIBRARY_LIMIT")
    public static Object writeSubayaiObject(SubayaiObject receiver, Object name, Object value,
                                       @Bind Node node,
                                       @CachedLibrary("receiver") DynamicObjectLibrary objectLibrary,
                                       @Cached SubayaiToTruffleStringNode toTruffleStringNode) {
        objectLibrary.put(receiver, toTruffleStringNode.execute(node, name), value);
        return value;
    }

    @Specialization(guards = "!isSubayaiObject(receiver)", limit = "LIBRARY_LIMIT")
    public static Object writeObject(Object receiver, Object name, Object value,
                    ...
                    @Cached SubayaiToMemberNode asMember) {
        try {
            objectLibrary.writeMember(receiver, asMember.execute(node, name), value);
        } catch (UnsupportedMessageException | UnknownIdentifierException | UnsupportedTypeException e) {
            // write was not successful. In Subayai we only have basic support for errors.
            throw SubayaiException.undefinedProperty(node, name);
        }
        return value;
    }

    public static boolean isSubayaiObject(Object receiver) {
        return receiver instanceof SubayaiObject;
    }
}
