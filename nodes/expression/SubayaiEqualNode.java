...
/**
 * The {@code ==} operator of Subayai is defined on all types. Therefore, we need a
 ...
 * {@link SubayaiLogicalNotNode negate} the {@code ==} operator.
 */
@NodeInfo(shortName = "==")
@OperationProxy.Proxyable(allowUncached = true)
public abstract class SubayaiEqualNode extends SubayaiBinaryNode {
    ...
    @Specialization
    @TruffleBoundary
    public static boolean doBigNumber(SubayaiBigInteger left, SubayaiBigInteger right) {
    ...
    public static boolean doTruffleString(TruffleString left, TruffleString right,
        ...
        return equalNode.execute(left, right, SubayaiLanguage.STRING_ENCODING);
    }

    @Specialization
    public static boolean doNull(SubayaiNull left, SubayaiNull right) {
        /* There is only the singleton instance of SubayaiNull, so we do not need equals(). */
        return left == right;
    }

    @Specialization
    public static boolean doFunction(SubayaiFunction left, Object right) {
        /*
         * Our function registry maintains one canonical SubayaiFunction object per function name, so we
         * do not need equals().
         */
        return left == right;
    }
    ...
    public static boolean doGeneric(Object left, Object right,
        ...
        try {
            ...
            } else if (left instanceof SubayaiBigInteger && right instanceof SubayaiBigInteger) {
                return doBigNumber((SubayaiBigInteger) left, (SubayaiBigInteger) right);
