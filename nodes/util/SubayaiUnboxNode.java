...
public abstract class SubayaiUnboxNode extends SubayaiExpressionNode {
    ...
    @Specialization
    public static SubayaiBigInteger fromBigNumber(SubayaiBigInteger value) {
        return value;
    }

    @Specialization
    public static SubayaiFunction fromFunction(SubayaiFunction value) {
        return value;
    }

    @Specialization
    public static SubayaiNull fromFunction(SubayaiNull value) {
        return value;
    }
