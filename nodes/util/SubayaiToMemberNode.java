...
public abstract class SubayaiToMemberNode extends Node {
    ...
    @Specialization
    @TruffleBoundary
    public static String fromBigNumber(SubayaiBigInteger value) {
    ...
    public static String fromInterop(Object value, @CachedLibrary("value") InteropLibrary interop) throws UnknownIdentifierException {
        try {
            if (interop.fitsInLong(value)) {
                ...
                return bigNumberToString((SubayaiBigInteger) value);
            } else {
                throw error(value);
            }
    ...
    @TruffleBoundary
    public static String bigNumberToString(SubayaiBigInteger value) {
        return value.toString();
    }
