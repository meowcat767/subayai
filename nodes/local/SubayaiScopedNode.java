 ...
 * SOFTWARE.
 */
package space.meowcats.subayai.nodes.local;
...
/**
 * The Subayai implementation of {@link NodeLibrary} provides fast access to local variables. It's used
...
public abstract class SubayaiScopedNode extends Node {

    /**
     * Index to the the {@link SubayaiBlockNode#getDeclaredLocalVariables() block's variables} that
     ...
     */
    @ExportMessage
    boolean accepts(@Shared("node") @Cached(value = "this", adopt = false) SubayaiScopedNode cachedNode) {
    ...
    @ExportMessage
    @SuppressWarnings("static-method")
    final Object getScope(Frame frame, boolean nodeEnter, @Shared("node") @Cached(value = "this", adopt = false) SubayaiScopedNode cachedNode,
                    @Cached(value = "this.findBlock()", adopt = false, allowUncached = true) Node blockNode) {
        if (blockNode instanceof SubayaiBlockNode) {
            return new VariablesObject(frame, cachedNode, nodeEnter, (SubayaiBlockNode) blockNode);
        } else {
            return new ArgumentsObject(frame, (SubayaiAstRootNode) blockNode);
        }
    }

    /**
     * Test if a function of that name exists. The functions are context-dependent, therefore do a
     * context lookup via {@link SubayaiContext#getCurrent(Node)}.
     */
    @ExportMessage
    ...
    private boolean hasRootInstanceSlowPath() {
        ...
        return SubayaiContext.get(this).getFunctionRegistry().getFunction(SubayaiStrings.getSubayaiRootName(getRootNode())) != null;
    }
    ...
    private Object getRootInstanceSlowPath() throws UnsupportedMessageException {
        // The instance of the current RootNode is a function of the same name.
        Object function = SubayaiContext.get(this).getFunctionRegistry().getFunction(SubayaiStrings.getSubayaiRootName(getRootNode()));
        if (function != null) {
            return function;
        } else {
    ...
    /**
     * Find block of this node. Traverse the parent chain and find the first {@link SubayaiBlockNode}. If
     * none is found, {@link RootNode} is returned.
     *
     * @return the block node, always non-null. Either SubayaiBlockNode, or SubayaiRootNode.
     */
    @NeverDefault
    public final Node findBlock() {
        Node parent = getParent();
        while (parent != null) {
            if (parent instanceof SubayaiBlockNode) {
                break;
            }
    ...
    /**
     * Set the index to the the {@link SubayaiBlockNode#getDeclaredLocalVariables() block's variables}
    ...
    /**
     * Scope of function arguments. This scope is provided by nodes just under a {@link SubayaiRootNode},
     * outside of a {@link SubayaiBlockNode block}.
     * <p>
     * The arguments declared by {@link SubayaiRootNode#getDeclaredArguments() root node} are provided as
     * scope members.
     */
    ...
    static final class ArgumentsObject implements TruffleObject {
        ...
        protected final SubayaiAstRootNode root;

        /**
         * The arguments depend on the current frame and root node.
         */
        ArgumentsObject(Frame frame, SubayaiAstRootNode root) {
            this.frame = frame;
            this.root = root;
        }
         ...
         */
        @ExportMessage
        boolean accepts(@Cached(value = "this.root", adopt = false) SubayaiRootNode cachedRoot) {
        ...
        Object getMembers(@SuppressWarnings("unused") boolean includeInternal) {
            SubayaiWriteLocalVariableNode[] writeNodes = root.getDeclaredArguments();
        ...
        int findArgumentIndex(String member) {
            TruffleString memberTS = SubayaiStrings.fromJavaString(member);
            SubayaiWriteLocalVariableNode[] writeNodes = root.getDeclaredArguments();
            for (int i = 0; i < writeNodes.length; i++) {
                SubayaiWriteLocalVariableNode writeNode = writeNodes[i];
                if (memberTS.equalsUncached(writeNode.getSlotName(), SubayaiLanguage.STRING_ENCODING)) {
                    return i;
                }
            }
            return -1;
    ...
    static final class VariablesObject implements TruffleObject {
        ...
        protected final SubayaiScopedNode node;  // the current node
        final boolean nodeEnter;            // whether the node was entered or is about to be exited
        @NeverDefault protected final SubayaiBlockNode block;  // the inner-most block of the current
                                                          // node

        VariablesObject(Frame frame, SubayaiScopedNode node, boolean nodeEnter, SubayaiBlockNode blockNode) {
            this.frame = frame;
            this.node = node;
         ...
         */
        @ExportMessage
        boolean accepts(@Cached(value = "this.node", adopt = false) SubayaiScopedNode cachedNode,
        ...
        Object toDisplayString(boolean allowSideEffects, @Shared("block") @Cached(value = "this.block", adopt = false) SubayaiBlockNode cachedBlock,
            ...
            if (parentBlock instanceof SubayaiBlockNode) {
                return "block";
            } else {
                return ((SubayaiRootNode) parentBlock).getTSName();
            }
        }
        ...
        boolean hasScopeParent(
                        @Shared("block") @Cached(value = "this.block", adopt = false) SubayaiBlockNode cachedBlock,
                        @Shared("parentBlock") @Cached(value = "this.block.findBlock()", adopt = false, allowUncached = true) Node parentBlock) {
            // Cache the parent block for the fast-path access
            return parentBlock instanceof SubayaiBlockNode;
        }
        ...
        Object getScopeParent(
            ...
            return new VariablesObject(frame, cachedBlock, true, (SubayaiBlockNode) parentBlock);
        }
        ...
        SourceSection getSourceLocation() {
            ...
            if (parentBlock instanceof RootNode) {
                ...
                assert parentBlock instanceof SubayaiRootNode : String.format("In SubayaiLanguage we expect SubayaiRootNode, not %s", parentBlock.getClass());
                return ((SubayaiRootNode) parentBlock).getSourceSection();
            } else {
        ...
        static final class WriteMember {
            ...
            static void doCached(VariablesObject receiver, String member, Object value,
                            ...
                            @Cached(value = "receiver.findWriteNode(member)", adopt = false) SubayaiWriteLocalVariableNode writeNode) throws UnknownIdentifierException, UnsupportedMessageException {
            ...
            static void doGeneric(VariablesObject receiver, String member, Object value) throws UnknownIdentifierException, UnsupportedMessageException {
                SubayaiWriteLocalVariableNode writeNode = receiver.findWriteNode(member);
                doWrite(receiver, member, writeNode, value);
            }

            private static void doWrite(VariablesObject receiver, String member, SubayaiWriteLocalVariableNode writeNode, Object value) throws UnknownIdentifierException, UnsupportedMessageException {
                if (writeNode == null) {
                    throw UnknownIdentifierException.create(member);
                }
                if (receiver.frame == null) {
        ...
        @SuppressWarnings("static-method")
        Object getMembers(@SuppressWarnings("unused") boolean includeInternal,
                        @Cached(value = "this.block.getDeclaredLocalVariables()", adopt = false, neverDefault = false, dimensions = 1, allowUncached = true) SubayaiWriteLocalVariableNode[] writeNodes,
        ...
        int findSlot(String member) {
            SubayaiWriteLocalVariableNode writeNode = findWriteNode(member);
            if (writeNode != null) {
         ...
         */
        SubayaiWriteLocalVariableNode findWriteNode(String member) {
            TruffleString memberTS = SubayaiStrings.fromJavaString(member);
            SubayaiWriteLocalVariableNode[] writeNodes = block.getDeclaredLocalVariables();
    ...
    static final class KeysArray implements TruffleObject {
        ...
        @CompilationFinal(dimensions = 1) private final SubayaiWriteLocalVariableNode[] writeNodes;
         ...
         */
        KeysArray(SubayaiWriteLocalVariableNode[] writeNodes, int variableIndex, int parentBlockIndex) {
    ...
    /**
     * Representation of a variable based on a {@link SubayaiWriteLocalVariableNode write node} that
    ...
    static final class Key implements TruffleObject {
        ...
        private final SubayaiWriteLocalVariableNode writeNode;

        Key(SubayaiWriteLocalVariableNode writeNode) {
        ...
        SourceSection getSourceLocation() throws UnsupportedMessageException {
            ...
            SubayaiExpressionNode nameNode = writeNode.getNameNode();
