...
import space.meowcats.subayai.nodes.interop.NodeObjectDescriptor;
...
@NodeField(name = "nameNode", type = SubayaiExpressionNode.class)
@NodeField(name = "declaration", type = boolean.class)
public abstract class SubayaiWriteLocalVariableNode extends SubayaiExpressionNode {

    /**
     * Returns the descriptor of the accessed local variable. The implementation of this method is
     * created by the Truffle DSubayai based on the {@link NodeField} annotation on the class.
     */
    protected abstract int getSlot();

    /**
     * Returns the child node <code>nameNode</code>. The implementation of this method is created by
     * the Truffle DSubayai based on the {@link NodeChild} annotation on the class.
     */
    protected abstract SubayaiExpressionNode getNameNode();
     ...
     * therefore a Truffle DSubayai {@link #isLongOrIllegal(VirtualFrame) custom guard} is specified.
     */
     ...
     * {@link Fallback} method, the Truffle DSubayai generated code would try all other specializations
     ...
     *            Truffle DSubayai would not check the guard on every execution of the specialization.
    ...
    public Object getNodeObject() {
        SubayaiExpressionNode nameNode = getNameNode();
