 ...
 * variables {@link SubayaiNodeFactory#addFormalParameter in the method prologue}.
 */
public class SubayaiReadArgumentNode extends SubayaiExpressionNode {
    ...
    public SubayaiReadArgumentNode(int index) {
        this.index = index;
    }
