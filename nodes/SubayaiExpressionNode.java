...
/**
 * Base class for all Subayai nodes that produce a value and therefore benefit from type specialization.
 * The annotation {@link TypeSystemReference} specifies the Subayai types. Specifying it here defines the
 * type system for all subclasses.
 */
@TypeSystemReference(SubayaiTypes.class)
@NodeInfo(description = "The abstract base node for all expressions")
@GenerateWrapper
public abstract class SubayaiExpressionNode extends SubayaiStatementNode {
    ...
    /**
     * When we use an expression at places where a {@link SubayaiStatementNode statement} is already
    ...
    public WrapperNode createWrapper(ProbeNode probe) {
        return new SubayaiExpressionNodeWrapper(this, probe);
    }
    ...
    public long executeLong(VirtualFrame frame) throws UnexpectedResultException {
        return SubayaiTypesGen.expectLong(executeGeneric(frame));
    }

    public boolean executeBoolean(VirtualFrame frame) throws UnexpectedResultException {
        return SubayaiTypesGen.expectBoolean(executeGeneric(frame));
    }
}
