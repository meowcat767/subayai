...
/**
 * The base class of all Truffle nodes for Subayai. All nodes (even expressions) can be used as
 * statements, i.e., without returning a value. The {@link VirtualFrame} provides access to the
 * local variables.
 */
@NodeInfo(language = "Subayai", description = "The abstract base node for all Subayai statements")
@GenerateWrapper
public abstract class SubayaiStatementNode extends SubayaiScopedNode implements InstrumentableNode {
    ...
    public WrapperNode createWrapper(ProbeNode probe) {
        return new space.meowcats.subayai.nodes.SubayaiStatementNodeWrapper(this, probe);
    }
