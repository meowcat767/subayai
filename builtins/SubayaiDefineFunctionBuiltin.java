...
public abstract class SubayaiDefineFunctionBuiltin extends SubayaiBuiltinNode {

    @TruffleBoundary
    @Specialization
    public TruffleString defineFunction(TruffleString code, @Bind SubayaiContext context) {
        // @formatter:off
        Source source = Source.newBuilder(SubayaiLanguage.ID, code.toJavaStringUncached(), "[defineFunction]").
            build();
        // @formatter:on
