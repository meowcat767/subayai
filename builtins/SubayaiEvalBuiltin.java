...
public abstract class SubayaiEvalBuiltin extends SubayaiBuiltinNode {
    ...
    protected CallTarget parse(TruffleString id, TruffleString code) {
        ...
        return SubayaiContext.get(this).parse(source);
    }
    ...
    protected static boolean stringsEqual(TruffleString.EqualNode node, TruffleString a, TruffleString b) {
        return node.execute(a, b, SubayaiLanguage.STRING_ENCODING);
    }
}
