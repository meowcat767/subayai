...
public abstract class SubayaiJavaTypeBuiltin extends SubayaiBuiltinNode {
    ...
    public Object doLookup(Object symbolName,
        ...
        try {
             ...
             * are expressible also in Subayai. Like function calls on objects.
             */
            return context.getEnv().lookupHostSymbol(interop.asString(symbolName));
        } catch (UnsupportedMessageException e) {
            throw SubayaiException.create("The java builtin expected a String argument, but a non-string argument was provided.", this);
        }
    }
