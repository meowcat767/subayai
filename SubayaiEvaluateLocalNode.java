...
final class SubayaiEvaluateLocalNode extends RootNode {

    private final TruffleString variable;
    private final MaterializedFrame inspectFrame;

    SubayaiEvaluateLocalNode(SubayaiLanguage language, TruffleString variableName, MaterializedFrame frame) {
        super(language);
