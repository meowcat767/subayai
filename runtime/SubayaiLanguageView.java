 ...
 * calls routines to print such values the Subayai way. It is important to note that language
...
public final class SubayaiLanguageView implements TruffleObject {

    final Object delegate;

    SubayaiLanguageView(Object delegate) {
    ...
    boolean hasMetaObject(@CachedLibrary("this.delegate") InteropLibrary interop) {
         ...
         * SubayaiFunction is already associated with the SubayaiLanguage and therefore the language view will
         * not be used.
         */
        for (SubayaiType type : SubayaiType.PRECEDENCE) {
    ...
    public static Object create(Object value) {
        ...
        return new SubayaiLanguageView(value);
    }
    ...
    private static boolean isPrimitiveOrFromOtherLanguage(Object value) {
        ...
        try {
            return !interop.hasLanguage(value) || interop.getLanguage(value) != SubayaiLanguage.class;
        } catch (UnsupportedMessageException e) {
            throw shouldNotReachHere(e);
        }
    }
     ...
     * that are already originating from Subayai. This is useful to view values from the
    ...
    public static Object forValue(Object value) {
        ...
        try {
            if (lib.hasLanguage(value) && lib.getLanguage(value) == SubayaiLanguage.class) {
                return value;
            } else {
                return create(value);
            }
