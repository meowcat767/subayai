...
public final class SubayaiStrings {
    ...
    public static TruffleString fromJavaString(String s) {
        return TruffleString.fromJavaStringUncached(s, SubayaiLanguage.STRING_ENCODING);
    }
    ...
    public static TruffleString getSubayaiRootName(RootNode rootNode) {
