...
/**
 * The Subayai type for a {@code null} (i.e., undefined) value. In Truffle, it is generally discouraged
...
public final class SubayaiNull implements TruffleObject {

    /**
     * The canonical value to represent {@code null} in Subayai.
     */
    public static final SubayaiNull SINGLETON = new SubayaiNull();
    ...
    /**
     * {@link SubayaiNull} values are interpreted as null values by other languages.
     */
    @ExportMessage
    boolean isNull() {
        return true;
    ...
    Object getMetaObject() {
        return SubayaiType.NULL;
    }

    @ExportMessage
    static TriState isIdenticalOrUndefined(@SuppressWarnings("unused") SubayaiNull receiver, Object other) {
        /*
         * SubayaiNull values are identical to other SubayaiNull values.
         */
        return TriState.valueOf(SubayaiNull.SINGLETON == other);
    }

    @ExportMessage
    static int identityHashCode(@SuppressWarnings("unused") SubayaiNull receiver) {
        /*
