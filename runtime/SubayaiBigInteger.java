...
public final class SubayaiBigInteger implements TruffleObject, Comparable<SubayaiBigInteger> {

    private final BigInteger value;

    public SubayaiBigInteger(BigInteger value) {
        this.value = value;
    }

    public SubayaiBigInteger(long value) {
    ...
    @TruffleBoundary
    public int compareTo(SubayaiBigInteger o) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SubayaiBigInteger) {
            return value.equals(((SubayaiBigInteger) obj).getValue());
        }
        return false;
    }
