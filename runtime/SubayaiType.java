...
/**
 * The builtin type definitions for Subayai. Subayai has no custom types, so it is not possible
 * for a guest program to create new instances of SubayaiType.
 * <p>
 ...
 * <p>
 * In order to assign types to guest language values, Subayai values implement
 ...
 * assigned using language views.
 */
@ExportLibrary(InteropLibrary.class)
@SuppressWarnings("static-method")
public final class SubayaiType implements TruffleObject {
     ...
     * additional checks need to be performed (similar to number checking for SubayaiBigNumber).
     */
    public static final SubayaiType NUMBER = new SubayaiType("Number", (l, v) -> l.fitsInLong(v) || v instanceof SubayaiBigInteger);
    public static final SubayaiType NULL = new SubayaiType("NULL", (l, v) -> l.isNull(v));
    public static final SubayaiType STRING = new SubayaiType("String", (l, v) -> l.isString(v));
    public static final SubayaiType BOOLEAN = new SubayaiType("Boolean", (l, v) -> l.isBoolean(v));
    public static final SubayaiType OBJECT = new SubayaiType("Object", (l, v) -> l.hasMembers(v));
    public static final SubayaiType FUNCTION = new SubayaiType("Function", (l, v) -> l.isExecutable(v));
     ...
     * example, an object might be a function. In Subayai we decided to make functions,
     * functions and not objects.
     */
    @CompilationFinal(dimensions = 1) public static final SubayaiType[] PRECEDENCE = new SubayaiType[]{NULL, NUMBER, STRING, BOOLEAN, FUNCTION, OBJECT};

    private final String name;
    private final TypeCheck isInstance;

    /*
     * We don't allow dynamic instances of SubayaiType. Real languages might want to expose this for
     * types that are user defined.
     */
    private SubayaiType(String name, TypeCheck isInstance) {
        this.name = name;
     ...
     * cast {@link SubayaiType} to a constant.
     */
    ...
    /*
     * All SubayaiTypes are declared as interop meta-objects. Other example for meta-objects are Java
    ...
    /*
     * Subayai does not have the notion of a qualified or simple name, so we return the same type name
     * for both.
     */
    ...
    public String toString() {
        return "SubayaiType[" + name + "]";
    }

    /*
     * The interop message isMetaInstance might be used from other languages or by the {@link
     * SubayaiIsInstanceBuiltin isInstance} builtin. It checks whether a given value, which might be a
     * primitive, foreign or Subayai value is of a given Subayai type. This allows other languages to make
    ...
    static class IsMetaInstance {
        ...
        static boolean doCached(@SuppressWarnings("unused") SubayaiType type, Object value,
                                @Cached("type") SubayaiType cachedType,
        ...
        static boolean doGeneric(SubayaiType type, Object value) {
