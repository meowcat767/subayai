...
final class FunctionsObject implements TruffleObject {
    ...
    final Map<TruffleString, SubayaiFunction> functions = new HashMap<>();
    ...
    Object readMember(String member) throws UnknownIdentifierException {
        Object value = functions.get(SubayaiStrings.fromJavaString(member));
        if (value != null) {
            return value;
        }
    ...
    boolean isMemberReadable(String member) {
        return functions.containsKey(SubayaiStrings.fromJavaString(member));
    }
