 ...
 * SOFTWARE.
 */
package space.meowcats.subayai.bytecode;
...
import space.meowcats.subayai.nodes.expression.SubayaiLogicalNotNode;
...
import space.meowcats.subayai.nodes.util.SubayaiToBooleanNode;
import space.meowcats.subayai.nodes.util.SubayaiUnboxNode;
import space.meowcats.subayai.runtime.SubayaiFunction;
import space.meowcats.subayai.runtime.SubayaiNull;

@GenerateBytecode(//
                languageClass = SubayaiLanguage.class, //
                 ...
                 * {@link SubayaiBytecodeParser#visitFunction}.
                 */
                enableRootBodyTagging = false, //
                tagTreeNodeLibrary = SubayaiBytecodeScopeExports.class, enableSerialization = true, //
                enableTagInstrumentation = true)
@TypeSystemReference(SubayaiTypes.class)
@OperationProxy(SubayaiAddNode.class)
@OperationProxy(SubayaiDivNode.class)
@OperationProxy(SubayaiEqualNode.class)
@OperationProxy(SubayaiLessOrEqualNode.class)
@OperationProxy(SubayaiLessThanNode.class)
@OperationProxy(SubayaiLogicalNotNode.class)
@OperationProxy(SubayaiMulNode.class)
@OperationProxy(SubayaiReadPropertyNode.class)
@OperationProxy(SubayaiSubNode.class)
@OperationProxy(SubayaiWritePropertyNode.class)
@OperationProxy(SubayaiUnboxNode.class)
@OperationProxy(SubayaiFunctionLiteralNode.class)
@OperationProxy(SubayaiToBooleanNode.class)
@ShortCircuitOperation(name = "SubayaiAnd", booleanConverter = SubayaiToBooleanNode.class, operator = Operator.AND_RETURN_CONVERTED)
@ShortCircuitOperation(name = "SubayaiOr", booleanConverter = SubayaiToBooleanNode.class, operator = Operator.OR_RETURN_CONVERTED)
public abstract class SubayaiBytecodeRootNode extends SubayaiRootNode implements BytecodeRootNode {

    protected SubayaiBytecodeRootNode(SubayaiLanguage language, FrameDescriptor frameDescriptor) {
    ...
    @Override
    public SubayaiExpressionNode getBodyNode() {
        return null;
    }
    ...
    // see also SubayaiReadArgumentNode
    @Operation(tags = AlwaysHalt.class)
    public static final class SubayaiAlwaysHalt {
    ...
    public static final class SubayaiLoadArgument {
    ...
    public static final class Builtin {
        ...
        static Object doInBounds(VirtualFrame frame,
                        ...
                        @Bind Node bytecode,
                        @Bind("frame.getArguments()") Object[] arguments,
                        @Shared @Cached(value = "createBuiltin(factory)", uncached = "getUncachedBuiltin()", neverDefault = true) SubayaiBuiltinNode builtin) {
        ...
        static Object doOutOfBounds(VirtualFrame frame,
            ...
            for (int i = 0; i < argumentCount; i++) {
                if (i < originalArguments.length) {
                    ...
                    arguments[i] = SubayaiNull.SINGLETON;
                }
            }
            return doInvoke(frame, bytecode, builtin, arguments);
        }

        static SubayaiBuiltinNode createBuiltin(NodeFactory<?> factory) {
            return (SubayaiBuiltinNode) factory.createNode();
        }

        static SubayaiBuiltinNode getUncachedBuiltin() {
            /*
        ...
        private static Object doInvoke(VirtualFrame frame, Node node, SubayaiBuiltinNode builtin, Object[] arguments) {
            try {
                ...
                throw SubayaiException.typeError(e.getNode(), e.getSuppliedValues());
            }
        }
    ...
    @Operation
    public static final class SubayaiInvoke {
        @Specialization(limit = "3", //
                        guards = "function.getCallTarget() == cachedTarget", //
                        assumptions = "callTargetStable")
        @SuppressWarnings("unused")
        protected static Object doDirect(SubayaiFunction function, @Variadic Object[] arguments,
        ...
        protected static Object doIndirect(SubayaiFunction function, @Variadic Object[] arguments,
                                           @Cached IndirectCallNode callNode) {
            /*
             * Subayai has a quite simple call lookup: just ask the function for the current call target,
             * and call it.
             */
        ...
        protected static Object doInterop(
            ...
            try {
                ...
                throw SubayaiException.undefinedFunction(location, function);
            }
        }
    }
}
